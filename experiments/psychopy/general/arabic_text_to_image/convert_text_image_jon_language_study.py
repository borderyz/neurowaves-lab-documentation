...
if __name__ == "__main__":
    ...
    csv_files = [
                 'egyptian_backward.csv',
                 'egyptian_bound.csv',
                 'emirati_backward.csv',
                 'emirati_bound.csv',
                 ]
        ...
        # How to use the class and its methods
            for word_i in range(len(text_shaped_words)):
                ...
                arabic_word = ArabicWord(
                    word_string=text_shaped_words[word_i],
                    font_path=font_path,
                    font_size=font_size,
                    debug=TERMINAL_LOGS
                )
                ...
                file_name = "sentence_"+str(index)+"_word_"+str(word_i)+".png"
                save_path = os.path.join(SAVE_PATH[csv_i], file_name)
                arabic_word.word_img.save(save_path)
            ...
            #Uncomment if need sentence generation
            ...
            #     debug=TERMINAL_LOGS
            # )
            # file_name = "my_image.png"  # Specify the desired file name
            # sentence_img.save(file_name)
            #
