        ...
        if wordIndex == max(range(numWords)):
            ...
            for frameN in range(wordOn):
                ...
                if wordIndex==0 and frameN==0:
                    ...
                    dp.DPxSetDoutValue(trialList[trialIndex]['trigger224'] * trigger_channels_dictionary[224] +
                            trialList[trialIndex]['trigger225'] * trigger_channels_dictionary[225] +
                            ...
                            trialList[trialIndex]['trigger231'] * trigger_channels_dictionary[231],0xFFFFFF) # add trigger to channel here
                    dp.DPxUpdateRegCache()
                    core.wait(0.1)
                    dp.DPxSetDoutValue(RGB2Trigger(black), 0xFFFFFF)
                    dp.DPxUpdateRegCache()
