...
Instruction = ['Welcome to the experiment!\n\n' ...
    ...
    'left little finger = 1, left ring finger = 2, left middle finger = 3, left index finger = 4, left thumb = 5.\n\n' ...
    ...
    'Then you need to answer a simple YES/NO/DONT KNOWN question about the object (e.g., "Is it food?").\n' ...
    'Please respond by pressing right box:\n' ...
    'right thumb = YES, right index finger = NO\n' ...
    'right middle finger = DONT KNOW (if you did not understand the object)\n\n' ...
    ...
    'Please tell experimenter if you understand everything.'];
