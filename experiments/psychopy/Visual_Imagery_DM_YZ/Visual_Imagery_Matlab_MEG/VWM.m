...
%% Preallocate results
results = repmat(struct('Block',NaN, 'BlockRecallTime', '', 'Prompt','','Object','','Rate',NaN,'Rate_RT',NaN,...
...
for b = 1:nBlocks
    ...
    for idx = 1:height(T)
        ...
        % Randomly pick distractor image number (6, 8, or 10)
        distractImgNum = randsample([6 8 10], 1);
        ...
        Screen('DrawTexture', win, tex, [], ...
            CenterRectOnPoint([0 0 imgWidth imgHeight], s21screenX/2, screenY*0.25));
