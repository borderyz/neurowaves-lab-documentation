...
% Build filename
filename = fullfile(beh_datafolder, sprintf('Sub%s_Visual_WorkingMemory_MEG.csv', subNumStr));
TrigCheck_filename = fullfile(beh_datafolder, sprintf('Sub%s_TrigCheck_Visual_WorkingMemory_MEG.csv', subNumStr));
